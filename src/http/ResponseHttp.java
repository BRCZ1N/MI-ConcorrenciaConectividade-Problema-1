...
public class ResponseHttp {
	 ...
	 * completo.
	 * 
	 * @param statusLine - Representa o status da resposta da requisição.
	 * @param headers    - Representa os cabeçalhos da resposta http.
	 ...
	 * 
	 * @param headers - Os cabeçalhos da resposta http
	 */
