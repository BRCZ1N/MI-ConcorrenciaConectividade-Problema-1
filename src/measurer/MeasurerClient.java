...
/**
 * Esta � a classe MeasurerClient, que representa a aplica��o do medidor UDP que
...
public class MeasurerClient {
	...
	/**
	 * Este � o metodo que instancia o socket UDP do medidor
	 */
	...
	/**
	 * Esse � o metodo de execu��o do simulador de medidor da aplica��o.
	 */
